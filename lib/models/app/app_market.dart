...
class AppMarket {
  ...
  static List<AppMarketInfo> getBuildInMarketList(List<String> packageNames) {
    return buildInMarketList
        .where((market) => packageNames.contains(market.packageName))
        .toList();
  }

  /// 通过包名获取内置应用商店
  static AppMarketInfo getBuildInMarket(String packageName) {
    return buildInMarketList.firstWhere((market) => market.packageName == packageName);
  }
